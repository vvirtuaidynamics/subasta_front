export default {
  ...
  notifications: {
    ...
    errorValidation: "Rectifique los errores",
    noChanges: "No han ocurrido modificaciones",
    noChanges: "No han ocurrido modificaciones",
    sConfirmDelete:
      "Al eliminar el/la ${object} se eliminarán los siguientes objetos que a continuación se relacionan",
    mConfirmDelete:
      "Al eliminar los/las ${name} seleccionados(as) se eliminarán los siguientes objetos que a continuación se relacionan",
  },
  passwordChangeError: "Error al cambiar la contraseña!",
  passwordChangeSuccess: "Contraseña cambiada correctamente!",
  register: "Registrarse",
  ...
  validations: {
    Length: "El valor debe tener una longitud de ${length} caracteres",
  ...
  helpField: {
    ...
    email: "Debe ser un correo ejemplo: ejemplo@ejemplo.com",
    unique: "Unico",
    ipAddress: "Formato IPV4 ejemplo: 198.165.67.6",
    maxLength: "La longitud máxima permitida es ${max}",
    maxValue: "El valor máximo permitido es ${max}",
    ...
    numeric: "Numérico",
    required: "Requerido",
    sameAs: "Igual al valor de ${otherName}",
    validDate: "Formato DD/MM/YYYY ejemplo: 20/04/2020",
  },
  titles: {
