export default {
  ...
  notifications: {
    ...
    errorValidation: "Rectify the errors",
  ...
  helpField: {
    Length: "Value should have a length of ${length} chars",
    email: "Email, example: example@example.com",
    unique: "Unique",
    ipAddress: "Format IPV4 address, example: 198.165.67.6",
    maxLength: "The maximum length allowed is ${max}",
    maxValue: "The maximum value allowed is ${max}",
    minLength: "This field should be at least ${min} characters long",
    minValue: "The minimum value allowed is ${min}",
    numeric: "Numeric",
    required: "Required",
    sameAs: "Iqual to ${otherName}",
    validDate: "Format DD/MM/YYYY, example: 20/04/2020",
  },
  titles: {
